...
class PyTorchRunner(BaseRunner):
    """Control plane adapter for PyTorch model deployments.

    Uses the same HTTP contract as SklearnRunner but routes predictions
    through the pytorch_bridge.py execution engine on the worker side.
    """
